...
def rf_overlaps(bboxes1,bboxes2,mode='kl',eps=1e-6):
    '''
    计算gt与rf的距离,值越大越好
    Args:
        bboxes1: [b,n,4]
        bboxes2:[b,a,4]
        mode:str['wd', 'kl' 'exp_kl', 'kl_10']
        eps:

    Returns:[b,n,a]

    '''
    assert mode in ['wd', 'kl', 'exp_kl', 'kl_10'], f'Unsupported mode {mode}'
    if mode in ['kl','exp_kl', 'kl_10']:
